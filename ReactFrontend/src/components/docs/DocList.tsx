...
const DocList: React.FC<DocListProps> = ({
  ...
  return (
    <div className="px-3 pt-6 pb-24 h-full min-w-[250px] w-full md:w-[30%] lg:w-[20%] bg-white shadow border fixed z-40 overflow-auto">
              ...
              <div className="flex w-full justify-between">
                {renameDocId === doc.docsId ? (
                  ...
                  <Link to={`/docs/${doc.docsId}`}>
                    <span
                      className={`flex items-center py-2 px-3 text-lg font-semibold rounded-lg cursor-pointer transition-all duration-200 ${
                        isActive(`/docs/${doc.docsId}`)
                          ? "text-blue-700 hover:text-blue-900  bg-gray-200 hover:bg-gray-300"
