          ...
          <div className=" w-10/12 ml-auto bg-neutral-100 flex flex-col items-center pb-32  h-full min-h-screen">
            ...
            text-indigo-900 "
              ...
              <div className=" w-[90%] mx-auto items-center mt-2">
                <div className=" w-full h-fit bg-white rounded-[15px] border border-zinc-300 mx-auto pt-5">
                  <h1 className="text-black text-3xl px-10 pb-5">Member</h1>
                  {memberDatas
                    .sort((a, b) => {
                      ...
                      <>
                        ...
                        >
                          <div className="flex items-center ">
                            ...
                            />
                            <div className="ml-2">
                              <p className="text-indigo-900 text-2xl font-medium">
                ...
                <div className=" w-full h-fit bg-white rounded-[15px] border border-zinc-300 mx-auto pt-5 my-5">
                  <h1 className="text-black text-3xl px-10 pb-5">
